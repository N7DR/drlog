// $Id: diskfile.h 290 2026-03-30 15:48:47Z  $
...
*/
  inline explicit diskfile_exception(const std::string_view str) :
    _what (str)
  { }
...
*/
inline void append_to_file(const std::string_view filename, const std::string_view str)
...
void file_copy(const std::string_view source_filename, const std::string_view destination_filename);
...
*/
void file_rename(const std::string_view source_filename, const std::string_view destination_filename);
...
inline void file_move(const std::string_view source_filename, const std::string_view destination_filename)
...
std::vector<std::string> directory_contents(const std::string_view dirname, const FSID fsid = MAX_FSID);
