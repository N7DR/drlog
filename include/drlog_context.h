// $Id: drlog_context.h 292 2026-04-12 17:03:36Z  $
...
// Cabrillo records
  ...
  std::chrono::seconds                         _cluster_timeout                         { 300 };                        ///< five-minute timeout
  ...
  std::string                                  _dx_spotting_text                        { };                            ///< text in comment portion of DX spots
...
//  char                                         _thousands_separator                     { ',' };                            ///< character used as thousands separator in numbers
  char                                         _thousands_separator                     { COMMA };                            ///< character used as thousands separator in numbers
...
/// is the bandmap filter set to hide? (If not, then it's set to show)
  ...
  CONTEXTREAD(cluster_timeout);                  ///< cluster timeout in seconds
  ...
  CONTEXTREAD(dx_spotting_text);                 ///< text in comment portion of DX spots
